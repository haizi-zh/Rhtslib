...
package: "`r BiocStyle::pkg_ver('Rhtslib')`"
abstract: >
...
`r BiocStyle::Biocpkg("Rhtslib")` is an R package that provides the C `HTSlib`
...
The `r BiocStyle::Biocpkg("Rhtslib")` package is primarily useful to developers
...
contact the `r BiocStyle::Biocpkg("Rhtslib")` maintainer.
...
in `r BiocStyle::Biocpkg("Rhtslib")`, you must include a `src/Makevars` file.
